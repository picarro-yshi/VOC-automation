...
class Window(QWidget):
    ...
    def layout1(self):
        ...
        self.b12.setToolTip("Plot selected data in extra window; may not work on Windows.\n"
                            ...
                            "Maximum plot time is 8h, to prevent program crash.")
    ...
    def specplot(self):  ## may stop after a while on Wifi, but fine with Ethernet cable
        if self.func32():
            try:
                self.lb10.setText('Plotting spectrum on Tab 3. (Max 8h, then start again)')
    ...
    def plot1(self):  #plot spectrum and retain baseline list
        try:
            ...
            ## add first element, measure time/point
            for j in range(20):
                dm = dm_queue.get(timeout=5)
                print(j)
                print(dm['source'])
    ...
    def func80(self):
        try:
            ...
            if (not ta1.isdigit()) or (len(ta1) != 8):
                ...
                jupyternotebook(fnr, gas, cid, weight, MW, pct, ta1, ta2, ta3, tb1, tb2, tb3, tc1, tc2, tc3, row1, savefig=True)
