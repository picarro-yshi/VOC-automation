...
class Window(QWidget):
    ...
    def mainlayout(self):
        ...
        self.tabs.addTab(self.tab4, "     ⬥ Port Detection      ")
    ...
    def layout4(self):   # bottom row
        ...
        self.e81 = QLineEdit('R:\crd_G9000\AVXxx\\3610-NUV1022\R&D\Calibration\Yilin Shi')  #Folder
        self.e82 = QLineEdit('sam1')   #csv file name
        self.e83 = QLineEdit('3')  # cycle
    ...
    def layout8(self):
        ...
        self.L401.addLayout(self.g21)
        self.L401.addStretch()  # *** will tight the space
        ...
        try:
            ...
            def animate(i):
                ...
                if i in t_start:  #start a row
                    ...
                    self.fc1.set_flow_rate(row[1])
                    self.fc2.set_flow_rate(row[2] / 50)
                    self.fc3.set_flow_rate(row[3])
                    self.fc4.set_flow_rate(row[4] / 50)
                    self.fc5.set_flow_rate(row[5] * 10)
                ...
                ax1.clear()
                ax2.clear()
                ax1.plot(x, y1, linewidth=0.5, label='MFC1 (10SLPM)')
                ax2.plot(x, y2, linewidth=0.5, label='MFC2 (50SCCM)')
                ax2.plot(x, y3, linewidth=0.5, label='MFC3 (100SCCM)')
