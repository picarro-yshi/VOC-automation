...
## for aqueous droplets
def aqdp(fnr, gas, cid, weight, MW, pct, ta1, ta2, ta3, tb1, tb2, tb3, tc1, tc2, tc3, row=500, showgraph=False, savefig=False):
    gas_name = 'broadband_gasConcs_' + str(cid)  ## broadband_gasConcs_176
    cal_name = 'broadband_eCompoundOutputs_'+ str(cid) +'_calibration' ## broadband_eCompoundOutputs_176_calibration
    # fnr = "/Volumes/Data/crd_G9000/AVXxx/3610-NUV1022/R&D/Calibration/176 - Acetic Acid/20211124c"
...
if __name__ == "__main__":
    ...
    # gas = '674 - Dimethylamine in water'
    # gas = '1146 - Trimethylamine in water'
    # gas = '3776 - 2-Propanol in water'
    # gas = '8857 - Ethyl Acetate'
    # gas = '4685 - 1,4-dichlorobenzene'
    gas = '11169 - Octamethylcyclotetrasiloxane (D4)'
    row1 = 400
    # 1: droplet, 2: tank, 3: combo study, 4: find row num, 5: row dimensions, 6: aqueous droplet
    experiment = 1
    ...
    if not os.path.exists(fnr):
        ...
        if experiment == 1:
            ...
            temp = f.read().splitlines()
            MW = temp[0]
            # aqdp(fnr, gas, cid, weight, MW, pct, ta1, ta2, ta3, tb1, tb2, tb3, tc1, tc2, tc3, row=row1, showgraph=True, savefig=False)
            aqdp(fnr, gas, cid, weight, MW, pct, ta1, ta2, ta3, tb1, tb2, tb3, tc1, tc2, tc3, row=row1, showgraph=False, savefig=True)
