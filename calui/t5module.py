## VOC Automation: test if equipment works; test if Python library are present for main GUI
...
analyzer_source = 'VOC_broadband Analysis'   ## listener data key
...
######## module testing  ########################
host = '10.100.4.33'      ## IP address of analyzer
ipadd = 'http://'+host     ## ulr
