...
def specviewer(host, port, gas, analyzer_source, n=1000):
    dm_queue = Queue(180)  # data manager=-
    listener = Listener(dm_queue, host, port, StringPickler.ArbitraryObject, retry=True)
...
if __name__ == "__main__":
    host = '10.100.3.123'  ## IP address
    port = 40060
    gas = 'broadband_gasConcs_280'
    # gas = 'MFC2_flow'
    n = 2000              ## x-axis number  1000: <1.5h

    specviewer(host, port, gas, analyzer_source, n)
